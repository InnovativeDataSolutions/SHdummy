...
public class TwoGang extends AppCompatActivity {
    private Button btnon1,btnoff1,btnon2,btnoff2 ;
    Handler UIhandler;
    Context cx = this;
    Socket socket = null;
    Thread Thread1 = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_two_gang);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        btnon1 = (Button) findViewById(R.id.btnon2g);
        btnoff1 = (Button) findViewById(R.id.btnoff2g);

        btnon2 = (Button) findViewById(R.id.btn1on2g);
        btnoff2 = (Button) findViewById(R.id.btn1off2g);
            ...
            public void run() {
                ...
                try {
                    ...
                    if (click.contains("two")){
                        ...
                        out.flush();
                    }else if(click.contains("one")){
                        System.out.println(click);
                        byte[] by = hexStringToByteArray("02 03 00 00 00 83 03 47 00 00 00 00 00 00 00 30 01 02 AB 03".replaceAll(" ", ""));
                        out.write(by, 0, by.length);
                        out.flush();
                        ...
                        Toast.makeText(TwoGang.this, "Something went wrong,check connection", Toast.LENGTH_SHORT).show();
                    }
