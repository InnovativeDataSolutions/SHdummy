...
public class FourGang extends AppCompatActivity {
    Button on,off,on2,off2,on3,off3,on4,off4;
    Handler UIhandler;
    Context cx = this;
    Socket socket = null;
    Thread Thread1 = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_four_gang);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        on = (Button)findViewById(R.id.btnon4g);
        off = (Button)findViewById(R.id.btnoff4g);
        on2 = (Button)findViewById(R.id.btn1on4g);
        off2 = (Button)findViewById(R.id.btn1off4g);
        on3 = (Button)findViewById(R.id.btn2on4g);
        off3 = (Button)findViewById(R.id.btn2off4g);
        on4 = (Button)findViewById(R.id.btn3on4g);
        off4 = (Button)findViewById(R.id.btn3off4g);
        ...
        public void run() {
            ...
            try {
                ...
                if (click.contains("one")){
                    ...
                    Toast.makeText(FourGang.this, "Something went wrong,check connection", Toast.LENGTH_SHORT).show();
                }
