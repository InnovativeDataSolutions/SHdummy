...
public class ThreeGang extends AppCompatActivity {
    Button on,off,on2,off2,on3,off3;
    Handler UIhandler;
    Context cx = this;
    Socket socket = null;
    Thread Thread1 = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_three_gang);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        on = (Button)findViewById(R.id.btnon3g);
        off = (Button)findViewById(R.id.btnoff3g);
        on2 = (Button)findViewById(R.id.btn1on3g);
        off2 = (Button)findViewById(R.id.btn1off3g);
        on3 = (Button)findViewById(R.id.btn2on3g);
        off3 = (Button)findViewById(R.id.btn2off3g);
        ...
        public void run() {
            ...
            try {
                ...
                if (click.contains("one")){
                    ...
                    Toast.makeText(ThreeGang.this, "Something went wrong,check connection", Toast.LENGTH_SHORT).show();
                }
